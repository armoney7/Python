...
if word[0] in dict_eng:
    letter_choice = dict_eng
elif word[0] in dict_rus:
    letter_choice = dict_rus
else : print("Введены недопустимые символы!")

count = 0
if letter_choice:
    for letter in word:
        count += letter_choice[letter]
    print(f"Стоимость введенного слова '{word}' = {count} очков")
